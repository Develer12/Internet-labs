...
<script>
  ...
  function sum(async) {
    ...
    xhr.open("GET", "/Lab11_war_exploded/sss/header", async);
  ...
  function sum2(x,y,z) {
    const xhr = new XMLHttpRequest();
    xhr.open("POST", "/Lab11_war_exploded/sss/header", true);
  ...
  function getXML(n, async) {
    console.log(async);
    const xhr = new XMLHttpRequest();
    xhr.open("GET", "/Lab11_war_exploded/sss/xml", async);
  ...
  function getJSON(n, async) {
    console.log(async);
    const xhr = new XMLHttpRequest();
    xhr.open("GET", "/Lab11_war_exploded/sss/json", async);
    xhr.setRequestHeader("XRand-N", n);
    xhr.send();
    if (async) {
      xhr.onreadystatechange = () => {
